// Matching.cpp
// Feature matching stage of SFM pipeline.
// 
...
void Matching::match_images_with_pairs()
{
...
//) -> Dict[Tuple[str, str], List[Tuple[int, int]]]:
    ...
    //start = timer()
    //Logger::Write(__FUNCTION__, "Matching {} image pairs".format(len(pairs)))
    ...
    //Logger::Write(__FUNCTION__, "Computing pair matching with %d processes" % processes)
