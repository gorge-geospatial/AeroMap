...
constexpr double DEFAULT_Z = 1.0;
constexpr double MAXIMUM_Z = 8000;
constexpr double SAMPLE_Z = 100;
...
double PairSelect::sign(double x)
{
...
void PairSelect::get_gps_opk_point()
{
...
double PairSelect::find_best_altitude()
{
...
void PairSelect::get_representative_points()
{
...
void PairSelect::match_candidates_by_distance()
{
...
void PairSelect::match_candidates_by_graph()
{
    ...
    // Find by triangulating the GPS points on X/Y axes
    //
...
void PairSelect::match_candidates_with_bow()
{
...
void PairSelect::compute_bow_affinity()
{
    ...
    //    Logger::Write(__FUNCTION__, "Computing %d BoW histograms" % len(need_load))
    ...
    //    )
    //    Logger::Write(__FUNCTION__, "Computing BoW candidates with %d processes" % processes)
    //    return context.parallel_map(match_bow_unwrap_args, args, processes, batch_size)
}

void PairSelect::match_candidates_with_vlad()
{
...
void PairSelect::cmpute_vlad_affinity()
{
    ...
    //Logger::Write(__FUNCTION__, "Computing %d VLAD histograms" % len(need_load))
    ...
    //    data, preempted_candidates, histograms
    //)
    //Logger::Write(__FUNCTION__, "Computing VLAD candidates with %d processes" % processes)
    //return context.parallel_map(match_vlad_unwrap_args, args, processes, batch_size)
}

void PairSelect::preempt_candidates()
{
...
void PairSelect::construct_pairs()
{
//def construct_pairs(
...
void PairSelect::create_parallel_matching_args()
{
...
void PairSelect::match_bow_unwrap_args()
{
...
void PairSelect::match_vlad_unwrap_args()
{
...
void PairSelect::match_candidates_by_time()
{
...
void PairSelect::match_candidates_by_order()
{
...
void PairSelect::match_candidates_from_metadata()
{
...
void PairSelect::load_histograms()
{
...
void PairSelect::vlad_histogram_unwrap_args()
{
...
void PairSelect::vlad_histograms()
{
...
void PairSelect::pairs_from_neighbors()
{
